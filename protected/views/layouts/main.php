...
<div class="container-flex" id="page">
	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-expand-sm navbar-light bg-light">
			<a class="navbar-brand" href="/blog3/index.php/post/index"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logoConexa.png" class="img-fluid image" alt="logo Conexa"></a>
			...
			<div class="collapse navbar-collapse justify-content-end" id="main-navbar">
				<ul class="navbar-nav">
					<li class="nav-item"><a class="nav-link" href="/blog3/index.php/post/index">Home</a></li>
